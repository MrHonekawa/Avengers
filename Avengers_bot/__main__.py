...
from Avengers_bot import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
                          OWNER_ID, PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK,
                          dispatcher, StartTime, telethn, updater, pgram)
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from Avengers_bot.modules import ALL_MODULES
from Avengers_bot.modules.helper_funcs.chat_status import is_user_admin
from Avengers_bot.modules.helper_funcs.misc import paginate_modules
...
You can donate to the original writer of the Base code, MrHonekawa {EDWIN MCCOY (EDDY)}
There are two ways of supporting him; [TG](https://t.me/McCoyEddy), or [Money](https://t.me/)."""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Avengers_bot.modules." +
                                              module_name)
