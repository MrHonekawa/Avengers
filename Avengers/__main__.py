...
You can donate to the original writer of the Base code, MrHonekawa
There are Many ways of supporting him; [TG](t.me/McCoyEddy), or TRON = TDEkqwGaXNANsChdAe9YaH332SoVJWdiXF"""
                    ...
                    [[
                     ...
                     [
                         InlineKeyboardButton(
                             ...
                             url="https://t.me/TGBotLab/28")
                     ],
                     [
                         InlineKeyboardButton(
                             text="💾 Buy Own.",
                             url="https://t.me/McCoyEddy")
                     ]]))
    else:
        update.effective_message.reply_text(
            "Hey there, I am Online!\n<b>Up since:</b> <code>{}</code>".format(uptime),
