...
import Avengers.modules.sql.notes_sql as sql
from Avengers import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from Avengers.__main__ import DATA_IMPORT
from Avengers.modules.helper_funcs.chat_status import user_admin
from Avengers.modules.helper_funcs.alternate import typing_action

# from Avengers.modules.rules import get_rules
import Avengers.modules.sql.rules_sql as rulessql

# from Avengers.modules.sql import warns_sql as warnssql
import Avengers.modules.sql.blacklist_sql as blacklistsql
from Avengers.modules.sql import disable_sql as disabledsql

# from Avengers.modules.sql import cust_filters_sql as filtersql
# import Avengers.modules.sql.welcome_sql as welcsql
import Avengers.modules.sql.locks_sql as locksql
from Avengers.modules.connection import connected
...
def export_data(update, context):
    ...
    f = open("Avengers{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Avengers{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Avengers-Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
        reply_to_message_id=msg.message_id,
        parse_mode=ParseMode.MARKDOWN,
    )
    os.remove("Avengers{}.backup".format(chat_id))  # Cleaning file
