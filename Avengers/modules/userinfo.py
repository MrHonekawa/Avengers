...
from Avengers import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher, sw)
from Avengers.__main__ import STATS, TOKEN, USER_INFO
import Avengers.modules.sql.userinfo_sql as sql
from Avengers.modules.disable import DisableAbleCommandHandler
from Avengers.modules.sql.global_bans_sql import is_user_gbanned
from Avengers.modules.sql.afk_sql import is_afk, check_afk_status
from Avengers.modules.sql.users_sql import get_user_num_chats
from Avengers.modules.helper_funcs.chat_status import sudo_plus
from Avengers.modules.helper_funcs.extraction import extract_user
from Avengers import telethn as SaitamaTelethonClient, TIGERS, DRAGONS, DEMONS
