...
import Avengers.modules.sql.global_bans_sql as gban_sql
import Avengers.modules.sql.users_sql as user_sql
from Avengers import DEV_USERS, OWNER_ID, dispatcher
