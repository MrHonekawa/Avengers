...
from Avengers import DRAGONS, dispatcher
from Avengers.modules.disable import DisableAbleCommandHandler
from Avengers.modules.helper_funcs.chat_status import (bot_admin, can_pin,
                                                           can_promote,
                                                           connection_status,
                                                           user_admin,
                                                           ADMIN_CACHE)
...
from Avengers.modules.helper_funcs.alternate import send_message
...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    bot.sendMessage(
        chat.id,
        f"🔰 Hey! Hey! Just A Second! I did it! Sucessfully promoted, Now give me party..<b>{user_member.user.first_name or user_id}</b>!",
...
def demote(update: Update, context: CallbackContext) -> str:
    ...
    try:
        ...
        bot.sendMessage(
            chat.id,
            f"🔰Whop, Work Done!Sucessfully demoted, Give me a 2 min maggie.. <b>{user_member.user.first_name or user_id}</b>!",
            parse_mode=ParseMode.HTML)
